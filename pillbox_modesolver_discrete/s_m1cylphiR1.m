...
N_core  = 100;                   %Number of points for core
...
%n1 n2: cavity
[beta1,neff1,h1,q1,A1,B1,PhiE_cavity,Hr_cavity,Hz_cavity,r_r]=PillboxTV(a, rho_max, lambda, n1,n2); %run PillboxTV function to find transverse fields for n1/n2 layer
%n2 n3: mirror
[beta2,neff2,h2,q2,xx,xx,PhiE_mirror,Hr_mirror,Hz_mirror,r_r]=PillboxTV(a, rho_max, lambda, n3,n4); %run PillboxTV function to find transverse fields for n2/n3 layer
clear xx
