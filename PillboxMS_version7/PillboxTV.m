function [beta,neff,h,q,A,B,E_2D,Hr_2D,Hz_2D,r_r]=PillboxTV(radius,wavelength,n1,n2)
%%-----------------------------------------------------------------------%%
%PillboxMS(radius,wavelength,n1,n2)
%This function is the modesolver for the pillbox structure
%radius and wavelength must be in microns
%%-----------------------------------------------------------------------%%
% Inputs
a = radius; %microns
