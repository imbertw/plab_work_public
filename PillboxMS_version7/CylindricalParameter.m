...
error = 1e-9; %If we get the error message Error using fzero (line 257)Function values at interval endpoints must be finite and real, good chance we need to increase the error
