...
title('Dependence of length on radius')
ylabel('Length of cavity/\mum')
xlabel('Radius/\mum')
set(gcf,'color','w');
set(gca,'FontSize',12);
...
figure
plot(L,mdvolume,'LineWidth',2)
title('Cavity Length versus mode volume')
ylabel('Mode volume/\mum^3')
xlabel('Cavity Length/\mum')
set(gcf,'color','w');
set(gca,'FontSize',12);
set(gca,'FontName','Arial');