...
for ii=1:length(etch_depth)
    ...
    [lambda_res omegas gammas SZ] = ring_resonances_box(0.7, 12.35, 1.55, 'gf45rfsoi_xs_box', 2.0, box_thickness);
    resonance_wavelength(ii) = lambda_res(gammas==88);
...
save('filter_resonances_vs_etch_depth_r12350nm_w700nm.mat')
