...
%width, lambda, and box_thickness in um
function xs_check_box(xs, width, lambda, box_thickness)

[nlyrs, dlyrsx, dlyrsy, left_to_rout] = eval([xs '(width,lambda,box_thickness)']);
